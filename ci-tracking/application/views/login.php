...
<html lang="en">
	...
	<body class="login-layout" onload="document.forms['login-form'].submit()">
									...
									<div class="widget-body">
										<div class="widget-main center">
											<h4 class="header blue lighter bigger">
												...
												<?php
												if(isset($_GET['gagal'])){
													echo "<div class='alert alert-danger center'>Username atau Password Salah</div>";
												} else {
													echo "&nbsp;";
												}
												?>
											...
											<form method="post" action="<?=base_url('login/ldap_login');?>" id="login-form">
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="Username" name="username" id="username" value="<?=$user;?>" autofocus required/>
